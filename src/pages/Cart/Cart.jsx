...
const Cart = () => {
  ...
  const clearCart = () => {
    if (Object.keys(items).length > 0) {
      ...
      window.alert('Для того щоб очистити корзину , треа спершу щось замовити)')
    }
  }
  ...
  return (
    <div className="container container--cart">
      <div className="cart">
        {isOrderCompleted ? (
          <OrderComplited
            title={isOrderCompleted && 'Заказ Оформлений '}
            description={isOrderCompleted && `Ваше замовлення  буде передано курєрскій службі `}
            image={'/img/assets/order.png'}
          />
        ) : (
          <>
            {' '}
